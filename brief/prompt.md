...
- Anda juga dapat menerima SINYAL GROUNDING dari DailyBrief.id dan LeaderBrief.id. Gunakan
  sinyal itu untuk menjelaskan mengapa konsep hari ini dipilih. Bila sinyal hanya tersedia
  dari salah satu situs, pakai yang tersedia dan jangan mengarang isi situs lain.
...
satu dasar pemilihan dari sinyal brief lain, satu gap lapangan, satu pertanyaan diagnosis,
satu batas berlaku, satu catatan ledger.
...
### 4. DIPICU OLEH (grounding editorial)
Wajib ada setelah 60 detik, sebelum pertanyaan hari ini:
<section class="trigger">
  <div class="blk-k">Dipicu oleh</div>
  <p>Sebut sinyal konkret dari DailyBrief.id dan/atau LeaderBrief.id yang membuat konsep ini relevan hari ini. Jangan menyalin panjang. Cukup satu-dua kalimat.</p>
...
Aturan: trigger bukan promosi silang. Trigger adalah alasan epistemik: mengapa pembaca butuh konsep ini untuk membaca pola di balik sinyal harian.

### 5. THE QUESTION (pertanyaan hari ini)
...
### 8. BLOK PENGETAHUAN (Lapis B, sumber kedalaman)
...
- Trigger: <section class="trigger"><div class="blk-k">Dipicu oleh</div><p>...</p><div class="field"><span class="fk">Mengapa konsep ini dipilih</span><p>...</p></div></section>
